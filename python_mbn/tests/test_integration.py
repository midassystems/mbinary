...
class IntegrationTests(unittest.TestCase):
    ...
    def test_buffer_store_with_metadata(self):
        ...
        ohlcv_msgs = buffer_obj.decode_to_array()
        # print(ohlcv_msgs[0].hd)
        # print(ohlcv_msgs[0].open)
        # print(ohlcv_msgs[0].close)
        # Extract nested fields and construct a DataFrame
        data = {
